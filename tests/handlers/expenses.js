...
describe('ExpensesUtils', () => {
  describe('displayNewExpense()', () => {
    ...
    it('new expense later than first expense (same month)', () => {
      ...
      const {row, rowMonth} = ExpensesUtils.displayNewExpense(expense, [firstExpense], true);
    ...
    it('new expense earlier than last expense (same month)', () => {
      ...
      const {row, rowMonth} = ExpensesUtils.displayNewExpense(expense, [lastExpense], true);
    ...
    it('new expense between displayed expenses (month already displayed)', () => {
      ...
      const {row, rowMonth} = ExpensesUtils.displayNewExpense(expense, [firstExpense, lastExpense], true);
